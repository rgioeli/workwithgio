...
const markApplicationStarted = () => {
  ...
  const handleOptionSelect = (field: keyof ClientFormData, value: string, autoAdvance: boolean = false) => {
    ...
    return (
      ...
      >
        ...
        <div className="bg-card border border-border rounded-lg p-4 max-w-sm mx-auto mb-8">
          <p className="text-sm text-muted-foreground mb-2">Your selected plan:</p>
          <p className="font-semibold text-lg">{currentPlan?.icon} {currentPlan?.name}</p>
        ...
        <form ref={formRef} onSubmit={handleSubmit(onSubmit)}>
          ...
          <AnimatePresence mode="wait">
            ...
            {currentStep === 1 && (
              ...
              >
                <div className="text-center mb-8">
                  <h3 className="text-xl font-semibold mb-2">What type of business do you own?</h3>
                  <p className="text-muted-foreground text-sm">Select the option that best describes your business.</p>
                </div>
                ...
                {errors.businessType && (
                  <p className="text-sm text-destructive text-center">{errors.businessType.message}</p>
                )}
              </motion.div>
            )}
            ...
            {currentStep === 2 && (
              ...
              >
                <div className="text-center mb-8">
                  <h3 className="text-xl font-semibold mb-2">What is your biggest challenge right now?</h3>
                  <p className="text-muted-foreground text-sm">This helps us understand how we can best help you.</p>
                </div>
                ...
                {selectedChallenge === "other" && (
                  <motion.div
                    ...
                    className="space-y-2"
                  >
                    <Label htmlFor="biggestChallengeOther">Please describe your challenge</Label>
                    <Input
                ...
                {errors.biggestChallenge && (
                  <p className="text-sm text-destructive text-center">{errors.biggestChallenge.message}</p>
                )}
              </motion.div>
            )}
            ...
            {currentStep === 3 && (
              ...
              >
                <div className="text-center mb-8">
                  <h3 className="text-xl font-semibold mb-2">What would you like your website to help you accomplish?</h3>
                  <p className="text-muted-foreground text-sm">Select the primary goal for your new website.</p>
                </div>
                ...
                {errors.websiteGoal && (
                  <p className="text-sm text-destructive text-center">{errors.websiteGoal.message}</p>
                )}
              </motion.div>
            )}
                      ...
                      >
                        ...
                        <div className="mb-3">
                          {plan.additionalPrice ? (
                            <div>
                              <span className="text-2xl font-bold">+${plan.additionalPrice}</span>
                              <span className="text-muted-foreground">/month</span>
                              <p className="text-sm text-muted-foreground">(${plan.price}/month total)</p>
                            </div>
                          ) : (
                            <div>
                        ...
                        {plan.includesPrevious && (
                          <div className="mb-3 p-2 bg-muted/50 rounded-lg border border-border">
                            <p className="text-xs font-medium text-muted-foreground mb-1">Everything included in:</p>
                            <div className="flex flex-wrap gap-1">
                              {getIncludedPlanNames(plan.id).map((name, idx) => (
                                <span key={idx} className="text-xs bg-background px-2 py-0.5 rounded border border-border">
                                  {name}
                                </span>
                              ))}
                            </div>
            ...
            {currentStep === 5 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground text-sm">Select any additional services you&apos;re interested in. We&apos;ll discuss pricing if your application is approved.</p>
                </div>
                ...
                <p className="text-center text-sm text-muted-foreground">
                  These are optional. You can skip this step if you&apos;re not interested.
                </p>
              </motion.div>
            )}
            ...
            {currentStep === 6 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground text-sm">How can we reach you about your application?</p>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    {errors.phoneRaw && (
                      <p className="text-sm text-destructive">{errors.phoneRaw.message}</p>
                    )}
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="currentWebsiteUrl">Current Website URL (optional)</Label>
                  <Input
                    id="currentWebsiteUrl"
                    placeholder="example.com or https://www.example.com"
                    {...register("currentWebsiteUrl")}
                    className={errors.currentWebsiteUrl ? "border-destructive" : ""}
                  />
                  {errors.currentWebsiteUrl && (
                    <p className="text-sm text-destructive">{errors.currentWebsiteUrl.message}</p>
                  )}
            ...
            {currentStep === 7 && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground text-sm">Please review your selections before submitting.</p>
                </div>
                ...
                <div className="bg-card border border-border rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 border-b border-border">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-lg">{currentPlan?.icon} {currentPlan?.name}</span>
                      <span className="font-bold text-primary">${monthlyTotal}/mo</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-foreground text-background">
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="opacity-70">Website Maintenance Plan (Required):</span>
                        <span>$25/mo</span>
                      </div>
                      {selectedPlan !== "foundation" && (
                        <div className="flex justify-between text-sm">
                          <span className="opacity-70">{currentPlan?.name} Upgrade:</span>
                      ...
                      <div className="border-t border-background/20 pt-2 mt-2">
                        <div className="flex justify-between font-bold">
                          ...
                          <span className="text-primary">${monthlyTotal}/mo</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-muted/30 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{getValues("businessName") || "—"}</p>
                    </div>
                    <div>
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <Label htmlFor="termsAccepted" className="text-sm leading-relaxed cursor-pointer">
                      I understand that the website build is free for selected businesses, but the ${monthlyTotal}/month {currentPlan?.name} Plan and domain registration are required.
                    </Label>
                  </div>
